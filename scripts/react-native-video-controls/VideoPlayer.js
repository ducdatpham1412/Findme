    ...
    */
    ...
    _toggleFullscreen() {
        ...
        if (this.props.toggleResizeModeOnFullscreen) {
            state.resizeMode =
                state.isFullscreen === true ? 'cover' : 'contain';
        }
    ...
    setVolumePosition(position = 0) {
        ...
        state.volumeTrackWidth =
            this.player.volumeWidth - state.volumeFillWidth;
            ...
            onPanResponderMove: (evt, gestureState) => {
                ...
                if (
                    ...
                    const timeDifference =
                        Math.abs(state.currentTime - time) * 1000;
