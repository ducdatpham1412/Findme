...
export const showModalCommentDiscovery = (params: {
    post: TypeBubblePalace | TypeCreatePostResponse;
    setList: Function;
}) => {
    Redux.updateBubbleFocusing(params.post);
...
export default ModalCommentDiscovery;
